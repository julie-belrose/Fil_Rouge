...
-- Admins 1..15
(1,1,'sophie.m','Lyon 2e - Confluence',120),
(2,2,'lucas.b','Lyon 7e - Gerland',110),
(3,3,'emma.d','Lyon 3e - Part-Dieu',95),
(4,4,'hugo.l','Lyon 4e - Croix-Rousse',130),
(5,5,'chloe.m','Lyon 6e - Brotteaux',105),
(6,6,'nathan.lf','Lyon 9e - Vaise',90),
(7,7,'camille.r','Lyon 1er - Pentes',100),
(8,8,'louis.p','Lyon 5e - Vieux Lyon',115),
(9,9,'manon.g','Villeurbanne - Gratte-Ciel',80),
(10,10,'arthur.r','Lyon 8e - Monplaisir',88),
(11,11,'lea.f','Lyon 3e - Préfecture',92),
(12,12,'max.bl','Lyon 7e - Jean Macé',86),
(13,13,'sarah.mu','Lyon 6e - Foch',99),
(14,14,'thomas.c','Oullins',77),
(15,15,'ines.lm','Bron',74),
-- Agents 16..30
(16,16,'julien.l','Lyon 7e - Gerland',60),
(17,17,'clara.rn','Lyon 9e - Vaise',58),
(18,18,'mehdi.bn','Vénissieux - Minguettes',55),
(19,19,'pauline.gt','Lyon 3e - Montchat',53),
(20,20,'yohan.pr','Lyon 2e - Perrache',52),
(21,21,'amandine.rd','Villeurbanne - Flachet',50),
(22,22,'karim.bs','Vaulx-en-Velin - La Soie',49),
(23,23,'baptiste.mc','Lyon 1er - Terreaux',47),
(24,24,'aicha.kh','Bron - Terraillon',46),
(25,25,'quentin.nl','Lyon 6e - Tête d’Or',45),
(26,26,'melanie.cl','Lyon 4e - Plateau',44),
(27,27,'yassine.hd','Décines',43),
(28,28,'marine.pr','Tassin',42),
(29,29,'pierre.dp','Écully',41),
(30,30,'nora.ch','Charbonnières',40),
-- Citoyens 31..45
...
(action, message, actor_user_id, actor_role, report_oid, to_user_id, center_id, team_id,
 prev_status, new_status, prev_category, new_category, reason,
 file_path, file_size_kb, location_lat, location_lng, expected_before, channel, created_at)
VALUES
-- 1) citoyen crée un signalement (report #01 - Gerland)
('report.create','Création de signalement',31,'citizen','66fb00000000000000000001',NULL,1,301,
 NULL,NULL,NULL,NULL,NULL,
 NULL,NULL,45.734200,4.828900,NULL,NULL,'2025-10-06 07:45:05'),

-- 2) admin assigne un agent (report #02 - Vaise)
('report.assign','Affectation d’un agent au signalement',2,'admin','66fb00000000000000000002',NULL,2,302,
 NULL,NULL,NULL,NULL,NULL,
 NULL,NULL,NULL,NULL,NULL,NULL,'2025-10-05 11:05:00'),

-- 3) agent prend en charge (report #02)
('report.take_over','Prise en charge du signalement',17,'agent','66fb00000000000000000002',NULL,2,302,
 'ouvert','en_cours',NULL,NULL,NULL,
 NULL,NULL,NULL,NULL,NULL,NULL,'2025-10-05 13:30:00'),

-- 4) ajout de photo (report #03 - Part-Dieu)
('report.attachment.add','Ajout de pièce jointe (photo)',23,'agent','66fb00000000000000000003',NULL,3,303,
 NULL,NULL,NULL,NULL,NULL,
 '/uploads/2025/10/partdieu_003.jpg',820,NULL,NULL,NULL,NULL,'2025-10-03 11:05:00'),

-- 5) changement de statut → fermé (report #03)
('report.status.change','Changement de statut du signalement',23,'agent','66fb00000000000000000003',NULL,3,303,
 'en_cours','fermé',NULL,NULL,NULL,
 NULL,NULL,NULL,NULL,NULL,NULL,'2025-10-03 15:20:00'),

-- 6) rejet pour doublon (report #04 - Croix-Rousse)
('report.reject','Signalement rejeté (doublon)',2,'admin','66fb00000000000000000004',NULL,4,304,
 'ouvert','rejeté',NULL,NULL,'Doublon',
 NULL,NULL,NULL,NULL,NULL,NULL,'2025-10-04 10:00:00'),

-- 7) commentaire agent (report #05 - Villeurbanne)
('report.comment','Commentaire: Bac renversé, remplacement 10:30',21,'agent','66fb00000000000000000005',NULL,6,306,
 NULL,NULL,NULL,NULL,NULL,
 NULL,NULL,NULL,NULL,NULL,NULL,'2025-10-06 08:35:00'),

-- 8) notification envoyée à l’usager (report #02)
('notification.send','Notification: Prise en charge envoyée',2,'admin','66fb00000000000000000002',102,2,302,
 NULL,NULL,NULL,NULL,NULL,
 NULL,NULL,NULL,NULL,NULL,'push','2025-10-05 13:35:00'),

-- 9) SLA dépassé (report #06 - Vaulx)
('report.sla.breach','Dépassement du délai de traitement (SLA)',7,'admin','66fb00000000000000000006',NULL,7,307,
 NULL,NULL,NULL,NULL,NULL,
 NULL,NULL,NULL,NULL,'2025-10-07 08:00:00',NULL,'2025-10-07 09:10:00'),

-- 10) réaffectation d’équipe (report #08 - Bron)
('report.reassign','Réaffectation du signalement: charge élevée',11,'admin','66fb00000000000000000008',NULL,9,309,
 NULL,NULL,NULL,NULL,'Charge élevée',
 NULL,NULL,NULL,NULL,NULL,NULL,'2025-10-02 08:55:00'),

-- 11) requalification de catégorie (report #0a - Part-Dieu)
('report.requalify','Requalification: encombrants',5,'admin','66fb0000000000000000000a',NULL,3,303,
 NULL,NULL,'ordures ménagères','encombrants',NULL,
 NULL,NULL,NULL,NULL,NULL,NULL,'2025-10-05 08:20:00'),

-- 12) ajout d’un tag (report #01)
('report.tag.add','Tag ajouté: #marché',12,'admin','66fb00000000000000000001',NULL,1,301,
 NULL,NULL,NULL,NULL,NULL,
 NULL,NULL,NULL,NULL,NULL,NULL,'2025-10-06 09:00:00'),

-- 13) agent clôture avec photo (report #07 - Vénissieux)
('report.status.change','Clôture après intervention',27,'agent','66fb00000000000000000007',NULL,8,307,
 'ouvert','fermé',NULL,NULL,NULL,
 '/uploads/2025/09/venissieux_007.jpg',640,NULL,NULL,NULL,NULL,'2025-09-30 20:10:00'),

-- 14) admin modifie l’équipe (report #05 - Villeurbanne)
('report.reassign','Réaffectation: équipe 306 -> 306 (optimisation)',11,'admin','66fb00000000000000000005',NULL,6,306,
 NULL,NULL,NULL,NULL,'Optimisation de tournée',
 NULL,NULL,NULL,NULL,NULL,NULL,'2025-10-06 08:32:00'),

-- 15) rappel par email (report #06 - Vaulx)
('notification.send','Rappel envoyé à l’agent',7,'admin','66fb00000000000000000006',22,7,307,
 NULL,NULL,NULL,NULL,'Rappel SLA',
 NULL,NULL,NULL,NULL,NULL,'email','2025-10-07 09:15:00');
